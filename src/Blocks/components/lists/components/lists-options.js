		...
		<>
			...
			{listsUse &&
				<>
					...
					{showListsSize &&
						<CustomSelect
							label={<IconLabel icon={icons.textSize} label={__('Font size', 'andbrand-wp-plugin-block-base')} />}
							value={listsSize}
					...
					{showListsOrdered &&
						<SimpleHorizontalSingleSelect
							label={__('List type', 'andbrand-wp-plugin-block-base')}
							value={listsOrdered}
					...
					{showListsColorOnlyMarker &&
						<IconToggle
							...
							label={__('Show color only on list markers', 'andbrand-wp-plugin-block-base')}
