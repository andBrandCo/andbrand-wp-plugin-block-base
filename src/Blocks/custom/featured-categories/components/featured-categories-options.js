...
export const FeaturedCategoriesOptions = ({ attributes, setAttributes }) => {
	...
	return (
		<PanelBody title={__('Featured categories', 'andbrand-wp-plugin-block-base')}>

			{taxonomyOptions[0] &&
				<CustomSelect
					label={<IconLabel icon={<BlockIcon iconName='es-lists' />} label={__('Taxonomy type', 'andbrand-wp-plugin-block-base')} />}
					value={taxonomy}
			...
			{taxonomyOptions[0] && taxonomy &&
				<CustomSelect
					label={<IconLabel icon={icons.visible} label={sprintf(__('Show only these %s', 'andbrand-wp-plugin-block-base'), taxonomy.toLowerCase().replace('category', 'categories'))} />}
					help={__('If blank, all are shown', 'andbrand-wp-plugin-block-base')}
			...
			<RangeControl
				label={<IconLabel icon={icons.itemsPerRow} label={__('Items per row', 'andbrand-wp-plugin-block-base')} />}
