...
export const WrapperOptions = ({ attributes, setAttributes }) => {
	...
	return (
		<>
			{!wrapperDisable &&
				<PanelBody title={<span>{__('Layout', 'andbrand-wp-plugin-block-base')}</span>} initialOpen={false} icon={icons.wrapper} className='es-panel-title'>
					...
					{wrapperUseShowControl &&
						<IconToggle
							icon={icons.wrapper}
							label={__('Wrapper', 'andbrand-wp-plugin-block-base')}
							checked={wrapperUse}
					...
					{(wrapperUse && wrapperUseSimpleShowControl) &&
						<IconToggle
							...
							label={__('Simple wrapper', 'andbrand-wp-plugin-block-base')}
							checked={wrapperUseSimple}
							onChange={(value) => setAttributes({ wrapperUseSimple: value })}
							help={__('Provides only basic spacing and background options.', 'andbrand-wp-plugin-block-base')}
						/>
					}
					...
					{wrapperUse &&
						<>
							...
							{showWrapperSpacingTop &&
								<Responsive label={<IconLabel icon={icons.spacingTop} label={__('Top spacing', 'andbrand-wp-plugin-block-base')} />}>
							...
							{showWrapperSpacingBottom &&
								<Responsive label={<IconLabel icon={icons.spacingBottom} label={__('Bottom spacing', 'andbrand-wp-plugin-block-base')} />}>
									{options.breakpoints.map((item, index) => {
										const point = ucfirst(item);
							...
							{showWrapperSpacingTopIn &&
								<Responsive label={<IconLabel icon={icons.spacingTopIn} label={__('Top inner spacing', 'andbrand-wp-plugin-block-base')} />}>
									{options.breakpoints.map((item, index) => {
										const point = ucfirst(item);
							...
							{showWrapperSpacingBottomIn &&
								<Responsive label={<IconLabel icon={icons.spacingBottomIn} label={__('Bottom inner spacing', 'andbrand-wp-plugin-block-base')} />}>
									{options.breakpoints.map((item, index) => {
										const point = ucfirst(item);
							...
							{showWrapperDividerTop &&
								<Responsive label={<IconLabel icon={icons.dividerTop} label={__('Top divider', 'andbrand-wp-plugin-block-base')} />}>
									{options.breakpoints.map((item, index) => {
										const point = ucfirst(item);
							...
							{showWrapperDividerBottom &&
								<Responsive label={<IconLabel icon={icons.dividerBottom} label={__('Bottom divider', 'andbrand-wp-plugin-block-base')} />}>
									{options.breakpoints.map((item, index) => {
										const point = ucfirst(item);
							...
							{showWrapperHide &&
								<Responsive label={<IconLabel icon={icons.hide} label={__('Hide', 'andbrand-wp-plugin-block-base')} />}>
									{options.breakpoints.map((item, index) => {
										const point = ucfirst(item);
							...
							{showWrapperBackgroundColor &&
								<ColorPaletteCustom
									label={<IconLabel icon={icons.backgroundTypeAlt} label={__('Background color', 'andbrand-wp-plugin-block-base')} />}
							...
							{!wrapperUseSimple &&
								<>
									{showWrapperWidth &&
										<Responsive label={<IconLabel icon={icons.width} label={__('Width', 'andbrand-wp-plugin-block-base')} />}>
											{options.breakpoints.map((item, index) => {
									...
									{showWrapperOffset &&
										<Responsive label={<IconLabel icon={icons.offset} label={__('Offset', 'andbrand-wp-plugin-block-base')} />}>
											{options.breakpoints.map((item, index) => {
									...
									{showWrapperContainerWidth &&
										<Responsive label={<IconLabel icon={icons.containerWidth} label={__('Container width', 'andbrand-wp-plugin-block-base')} />}>
											{options.breakpoints.map((item, index) => {
												const point = ucfirst(item);
									...
									{showWrapperGutter &&
										<Responsive label={<IconLabel icon={icons.gutter} label={__('Gutter', 'andbrand-wp-plugin-block-base')} />}>
											{options.breakpoints.map((item, index) => {
							...
							{showWrapperAnchorId &&
								<TextControl
									label={<IconLabel icon={icons.anchor} label={__('Block anchor ID', 'andbrand-wp-plugin-block-base')} />}
							...
							{showWrapperId &&
								<TextControl
									label={<IconLabel icon={icons.id} label={__('Block unique identifier', 'andbrand-wp-plugin-block-base')} />}
									value={wrapperId}
